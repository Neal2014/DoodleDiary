...
@implementation TypeFaceInfoPickerView
       ...
       inComponent:(NSInteger)component
{
    ...
    doodleModel.typefaceFont=[UIFont fontWithName:viewOnViewofFontComponent.text size:[viewOnViewOfSizeComponent.text floatValue]];
    doodleModel.typefaceColor=viewOnViewOfColorComponent.backgroundColor;
    
    //代理传值
    if (nil != _typefaceDelegate && [_typefaceDelegate respondsToSelector:@selector(changeTypefaceInfoForDoodleDiaryTextView:)]) {
        [_typefaceDelegate changeTypefaceInfoForDoodleDiaryTextView:doodleModel];
    }
}
