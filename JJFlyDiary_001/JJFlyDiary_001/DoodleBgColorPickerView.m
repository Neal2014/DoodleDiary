...
#import "DoodleBgColorPickerView.h"

@implementation DoodleBgColorPickerView
       ...
       inComponent:(NSInteger)component
{
    ...
    //代理传值
    if (nil != _bgDelegate && [_bgDelegate respondsToSelector:@selector(changeDoodleBackgroundColorWith:)]) {
        [_bgDelegate changeDoodleBackgroundColorWith:viewOnViewOfColorComponent.backgroundColor];
    }
}
/*
